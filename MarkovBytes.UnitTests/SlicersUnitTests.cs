...
namespace Markov
{
    ...
    public class Slicer
    {
        ...
        public RowTree[] Slice(ushort[][] srcRows)
        {
            ...
            {
                var info = ArrangeSlices(srcRows[i]);
                dstRows[i] = ProcessRow(info);
            }
            return dstRows;
        }
        ...
        public RowTree ProcessRow(SliceInfo data)
        {
            ...
            // 2. leaf offset
            // 3. leaf array
            int BUCKET_SIZE, wholeBuckets, remainder;
            GetChunkInfo(data, out BUCKET_SIZE, out wholeBuckets, out remainder);
        ...
        public static RowBranch CreateRowBranch(int length)
        {
        ...
        public static ushort[] Get16BitMasks(SliceInfo data)
        {
...
namespace MarkovBytes.UnitTests
{
    public class SlicersUnitTests
    {
        ...
        public void BuildTree_0()
        {
            ...
            var actual = Slicer.Get16BitMasks(data);
            Assert.IsNotNull(actual);
